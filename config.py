...
class Config:
    def __init__(self) -> None:
        ...
        self.BOT_TOKEN: str = os.environ.get("7888797826:AAFGjnKEJQk6FoZRT4vUWScFDsvnC1PqHYk", None)
        self.SUDOERS: list = [
            int(id) for id in os.environ.get("5789538424", "5789538424").split() if id.isnumeric()
        ]
